...
from privateData import myData
...
SECRET_KEY = myData['SECRET_SETTINGS']
...
DATABASES = {
    'default': {
        ...
        'NAME': myData['POSTGRESQL_DB_NAME'],
        'USER': myData['USUARIO_POSTGRESQL'],
        'PASSWORD': myData['SENHA_POSTGRESQL'],
        'HOST': myData['HOST'],
        'PORT':'5432',
